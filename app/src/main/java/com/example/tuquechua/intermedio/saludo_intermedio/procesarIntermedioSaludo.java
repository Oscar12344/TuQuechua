...
public class procesarIntermedioSaludo extends AppCompatActivity  implements  Response.ErrorListener, Response.Listener<JSONObject>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_procesar_intermedio_saludo);
    ...
    public void llamarWebService() {
        ...
        if(users!=null){
            ...
            progreso.show();
            String url=getString(R.string.urlIP)+"pregunta/registroRankingSaludoIntermedio.php?nombre="+nombres+"&puntaje="+puntFinal;
