...
import com.example.tuquechua.RankingFamiliaIntermedio;
import com.example.tuquechua.RankingNumeroBasico;
import com.example.tuquechua.Secciones;
import com.example.tuquechua.intermedio.numero_intermedio.procesarIntermedioNumero;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseUser;

import org.json.JSONObject;

public class procesarIntermedioFamilia extends AppCompatActivity implements  Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_procesar_intermedio_familia);
        ...
        irRanking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), RankingFamiliaIntermedio.class);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), procesarIntermedioNumero.class);
                startActivity(i);
            }
        });
    }
    ...
    private void llamarWebService() {
        ...
        if(users!=null){
            ...
            progreso.show();
            String url=getString(R.string.urlIP)+"pregunta/registroRankingFamiliaIntermedio.php?nombre="+nombres+"&puntaje="+puntFinal;
