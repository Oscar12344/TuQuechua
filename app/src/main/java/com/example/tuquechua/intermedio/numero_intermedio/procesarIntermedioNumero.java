...
import com.example.tuquechua.RankingNumeroIntermedio;
import com.example.tuquechua.Secciones;
import com.example.tuquechua.intermedio.saludo_intermedio.procesarIntermedioSaludo;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseUser;

import org.json.JSONObject;

public class procesarIntermedioNumero extends AppCompatActivity implements  Response.ErrorListener, Response.Listener<JSONObject>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_procesar_intermedio_numero);
        ...
        irRanking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), RankingNumeroIntermedio.class);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), procesarIntermedioSaludo.class);
                startActivity(i);
            }
        });
    }
    ...
    public void llamarWebService() {
        ...
        if(users!=null){
            ...
            progreso.show();
            String url=getString(R.string.urlIP)+"pregunta/registroRankingNumeroIntermedio.php?nombre="+nombres+"&puntaje="+puntFinal;
