...
import com.example.tuquechua.RankingComidaIntermedio;
import com.example.tuquechua.RankingNumeroBasico;
import com.example.tuquechua.Secciones;
import com.example.tuquechua.intermedio.familia_intermedio.procesarIntermedioFamilia;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseUser;

import org.json.JSONObject;

public class procesarIntermedioComida extends AppCompatActivity implements  Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_procesar_intermedio_comida);
        ...
        irRanking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), RankingComidaIntermedio.class);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), procesarIntermedioFamilia.class);
                startActivity(i);
            }
        });
    }
