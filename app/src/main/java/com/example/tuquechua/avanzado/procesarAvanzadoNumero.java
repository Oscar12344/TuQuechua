...
import com.example.tuquechua.RankingNumeroAvanzado;
...
public class procesarAvanzadoNumero extends AppCompatActivity implements  Response.ErrorListener, Response.Listener<JSONObject>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_procesar_avanzado_numero);
        ...
        irRanking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), RankingNumeroAvanzado.class);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), procesarAvanzadoSaludo.class);
                startActivity(i);
            }
        });
    }
    ...
    private void llamarWebService() {
        ...
        if(users!=null){
            ...
            progreso.show();
            String url=getString(R.string.urlIP)+"pregunta/registroRankingNumeroAvanzado.php?nombre="+nombres+"&puntaje="+puntFinal;
