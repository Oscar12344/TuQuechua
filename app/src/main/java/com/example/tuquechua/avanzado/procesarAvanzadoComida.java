...
import com.example.tuquechua.RankingComidaAvanzado;
...
public class procesarAvanzadoComida extends AppCompatActivity   implements  Response.ErrorListener, Response.Listener<JSONObject>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_procesar_avanzado_comida);
        ...
        irRanking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), RankingComidaAvanzado.class);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), procesarAvanzadoFamilia.class);
                startActivity(i);
            }
        });
    }
    ...
    private void llamarWebService() {
        ...
        if(users!=null){
            ...
            progreso.show();
            String url=getString(R.string.urlIP)+"pregunta/registroRankingComidaAvanzado.php?nombre="+nombres+"&puntaje="+puntFinal;
