...
import com.example.tuquechua.RankingFamiliaAvanzado;
...
public class procesarAvanzadoFamilia extends AppCompatActivity implements  Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_procesar_avanzado_familia);
        ...
        irRanking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), RankingFamiliaAvanzado.class);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), procesarAvanzadoNumero.class);
                startActivity(i);
            }
        });
    }
    ...
    private void llamarWebService() {
        ...
        if(users!=null){
            ...
            progreso.show();
            String url=getString(R.string.urlIP)+"pregunta/registroRankingFamiliaAvanzado.php?nombre="+nombres+"&puntaje="+puntFinal;
