...
public class Basico_Ejercicio6_Numero extends AppCompatActivity implements  Response.Listener<JSONObject>,Response.ErrorListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url="http://192.168.1.7:80/pregunta/wsJSONConsultarPreguntaImagen.php?id="+23;
    ...
    public void iniciar(View view) {
        MediaPlayer mp= MediaPlayer.create(this, R.raw.suuta_seis);
        mp.start();
    }
    ...
    public void lanzarProcesarCalculo(String opbutton) {
        Intent i = new Intent(this, procesarBasicoNumero.class);
